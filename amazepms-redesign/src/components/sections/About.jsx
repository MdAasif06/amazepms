      ...
      <div className="mx-auto max-w-6xl">
        <div className="grid gap-14 lg:grid-cols-2 lg:items-center lg:gap-16">
              ...
              {highlights.map((h, i) => (
                <Reveal key={h.title} direction="up" delay={i * 0.08}>
                  <div className="flex gap-4">
                    <span className="mt-0.5 flex h-11 w-11 shrink-0 items-center justify-center rounded-xl border border-border bg-white/3 text-accent">
          ...
          <Reveal direction="left" className="relative">
            ...
            <div className="glass-strong rounded-4xl p-6 shadow-card">
              <div className="rounded-2xl border border-border bg-background/60 p-6">
                ...
                <ul className="mt-4 flex flex-col gap-3">
                  {[
                    ...
                    <li
                      key={row.t}
                      className="flex items-center justify-between gap-4 rounded-xl border border-border bg-white/2 px-4 py-3"
                    >
